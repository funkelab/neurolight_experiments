...
# Get fused snapshots using a carve out of the skeletonizations and a single neuron (G-002)
...
data_sources = tuple(
    ...
    + TopologicalMatcher(
        skeletonization, consensus, matched, failures=Path("matching_failures")
    )
    + RasterizeSkeleton(
        points=matched,
        array=labels,
