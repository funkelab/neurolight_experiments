...
files = [
    # '/nrs/funke/maisl/2018-04-25/swc-carved.h5',
...
def train_until(max_iteration, return_intermediates=False):
    ...
    pipeline = (
            ...
            data_sources +
            #gp.RandomProvider() +
            FusionAugment(ch1, ch2, gt, smoothness=3, return_intermediate=return_intermediates) +
...
if __name__ == "__main__":
    ...
    train_until(iteration, return_intermediates)
